...
function App() {
  ...
  return (
    <div className="font-bodoni text-gray-100">
      <div
        ref={about}
      ...
      <main ref={projects} className="bg-[#0f141b]">
        ...
        <Projects />
        <h2 ref={stack} className="w-full text-center text-3xl pt-[70px] lg:pt-[100px]">
          STACK
        </h2>
        <Stack />
      </main>
      ...
      >
        <div className="relative -rotate-90 md:rotate-0">
          <div className="rotate-90 h-[55px] w-[300px] absolute -bottom-[100px] -left-[110px] overflow-hidden md:overflow-visible">
          ...
          >
            <BsGithub
              className="mt-[8px] ml-[8px] lg:mt-[10px] lg:ml-[10px] text-black bg-gray-200 text-2xl lg:text-3xl"
            />
          </a>
          <a
            target="_blank"
          ...
          >
            <BsLinkedin
              className="mt-[8px] ml-[8px] lg:mt-[10px] lg:ml-[10px] text-[#0e76a8] bg-white rounded-sm text-2xl lg:text-3xl"
            />
          </a>
          <a
      ...
      <footer className="h-[50px] flex items-center justify-end pr-5 text-xs bg-[#0f141b] border-t-[0.1px] border-solid border-gray-100 z-50">
